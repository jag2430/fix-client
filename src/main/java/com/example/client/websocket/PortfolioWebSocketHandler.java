 ...
 * Clients connect via WebSocket and receive real-time position/execution/market data updates
...
public class PortfolioWebSocketHandler extends TextWebSocketHandler {
  ...
  public void init() {
    ...
    redisListenerContainer.addMessageListener(broadcastListener, marketDataTopic);

    log.info("Portfolio WebSocket handler initialized, listening to Redis channels: {}, {}, {}, {}",
        positionsTopic.getTopic(), executionsTopic.getTopic(),
        ordersTopic.getTopic(), marketDataTopic.getTopic());
  }
